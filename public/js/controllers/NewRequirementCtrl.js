app.controller('NewRequirementCtrl', ['$scope', '$http', function ( $scope, $http ) {
	...
	$scope.saveAction = function ( close ) {
		...
		$http.post( '/projects/' + $scope.project_id + '/requirements/create', $scope.requirement ).then( 
			...
			function () {
				...
				_alert( 'Failed to create project requirement.' );
