...
{    
  ...
  public static function isDomainAvailable( $domain ) {
    ...
    www\d*, feeds?, rss, asset[s\d]*, cp\d*, control panel, online, media, jobs?, secure, i\d*, img\d*, css\d*, js\d*';
