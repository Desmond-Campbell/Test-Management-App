...
@section('title')
{{$project->title}} - {{___( "Add Project Requirements" )}}
@stop
...
@section('content')
  ...
  <div layout="row">
    ...
    <div flex="80" class="main-content" ng-controller="NewRequirementCtrl">

      <div class="heading-cell">
        <h2>{{$project->title}} - {{___( "Add Project Requirements" )}}</h2>
      </div>
      ...
      <form class="form slim-form" role="form" method="post" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control input-lg" id="requirement-summary" ng-model="requirement.summary" placeholder="{{___( "Enter your actual requirement here. Be as clear and concise as possible." )}}" />
        ...
        <div class="form-group">
          ...
          <span class="help-block">{{___( "If this is a sub-requirement to another requirement, select the main requirement below." )}}</span>
...
@section('javascript')
  <script src="/js/controllers/NewRequirementCtrl.js"></script>
@stop
